...
export default async function CollectionsPage() {
  ...
  return (
    <div className="grid gap-6">
      <div>
        <h1 className="text-2xl font-black">Collectes TVA</h1>
        <p className="text-sm text-muted">Creez une periode mensuelle et envoyez les liens de depot.</p>
      </div>

      <section className="card p-4">
        <h2 className="mb-4 font-black">Nouvelle collecte</h2>
        <form action={createCollectionAction} className="grid gap-4 md:grid-cols-[1fr_150px_150px_auto] md:items-end">
        ...
        <div className="overflow-x-auto">
          <table>
            ...
            <tbody>
              ...
              {!collections.length ? (
                <tr><td colSpan={6} className="text-muted">Aucune collecte creee.</td></tr>
              ) : null}
            </tbody>
          </table>
        </div>
