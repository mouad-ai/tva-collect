    ...
    <main className="min-h-screen bg-white px-4 py-10">
      <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-[0.9fr_1.1fr]">
        <div>
          ...
          <h1 className="mt-6 text-3xl font-extrabold tracking-tight">Demander un pilote</h1>
          <p className="mt-3 leading-relaxed text-muted">
            Testez TVA Collect sur 5 dossiers clients ce mois-ci. Le pilote inclut la configuration,
            les liens de dépôt, le suivi documents et les modèles de relance.
          </p>
        </div>
        <section className="card p-6">
          ...
          <form action="/api/contact" method="post" className="grid gap-4">
            ...
            <label>
              Problème principal
              <textarea name="biggestProblem" rows={3} placeholder="Ex : clients qui envoient tout sur WhatsApp, documents manquants..." />
            </label>
