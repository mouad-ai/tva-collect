  ...
  return (
    <main className="min-h-screen bg-white px-4 py-10">
      <div className="mx-auto grid max-w-3xl gap-6">
        ...
        <h1 className="text-3xl font-black">Confidentialité</h1>
        <section className="card p-4 text-sm text-muted">
          ...
          <p className="mt-3">
            Les informations stockees peuvent inclure les coordonnees client, documents uploades, relances, evenements opérationnels et preuves de dépôt.
          </p>
          <p className="mt-3">
